...
use crate::game::overlay::widgets::labels::{
    draw_encounter_from, draw_encounter_to, draw_subtitle, draw_time_until, draw_title,
};
...
fn draw_info(
    ui: &mut Ui,
    view: &View,
    from: transfer_window_model::storage::entity_allocator::Entity,
    to: transfer_window_model::storage::entity_allocator::Entity,
) {
