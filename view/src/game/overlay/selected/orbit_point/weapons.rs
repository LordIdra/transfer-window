...
fn draw_fire(view: &View, ui: &mut Ui, center: Pos2, entity: Entity, slot_location: SlotLocation, time: f64) {
...
#[allow(clippy::too_many_arguments)]
fn draw_weapon(view: &View, ui: &mut Ui, entity: Entity, location: SlotLocation, slot: Option<&Weapon>, time: f64) {
...
#[allow(clippy::too_many_arguments)]
pub fn draw_weapons(view: &View, ui: &mut Ui, entity: Entity, weapon_slots: &[(SlotLocation, Option<&Weapon>)], time: f64) {
