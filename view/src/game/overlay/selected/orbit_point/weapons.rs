...
use transfer_window_model::{components::vessel_component::{ship::ship_slot::{weapon::Weapon, ShipSlotLocation, System}, timeline::fire_torpedo::FireTorpedoEvent}, storage::entity_allocator::Entity};
...
fn draw_fire(view: &View, ui: &mut Ui, center: Pos2, entity: Entity, slot_location: ShipSlotLocation, time: f64) {
    ...
    ui.allocate_ui_at_rect(lock_rect, |ui| {
        ...
        if ui.add_enabled(enabled, button).clicked() {
            let event = ModelEvent::CreateFireTorpedo { entity, slot_location, time };
...
#[allow(clippy::too_many_arguments)]
fn draw_weapon(view: &View, ui: &mut Ui, entity: Entity, location: ShipSlotLocation, slot: Option<&Weapon>, time: f64) {
