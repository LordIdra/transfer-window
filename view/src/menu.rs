...
use crate::game::storyteller::stories::{story_1_03::Story1_03, story_1_04::Story1_04};
            ...
            ui.horizontal(|ui| {
                ...
                ui.vertical(|ui| {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        self.draw_level(context, ui, &mut events, completed_levels, "1-04", Box::new(Story1_04));
                    });
                    // ui.add_space(15.0);
                    // ui.horizontal(|ui| {
