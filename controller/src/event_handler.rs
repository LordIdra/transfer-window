...
pub fn new_game(controller: &mut Controller, context: &Context) {
    ...
    let sun = model.allocate(EntityBuilder::default()
        ...
        .with_atmosphere_component(AtmosphereComponent::new(Rgba::from_rgb(1.0, 0.745, 0.341), 4.0, 0.5, 2.0)));
    ...
    let earth = model.allocate(EntityBuilder::default()
        ...
        .with_atmosphere_component(AtmosphereComponent::new(Rgba::from_rgb(0.529, 0.808, 0.922), 2.0, 0.1, 6.0)));
