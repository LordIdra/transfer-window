...
use transfer_window_model::{Model, SEGMENTS_TO_PREDICT};

/// This example was taken from insanity-1 (note insanity-1 case may have
/// changed from time of writing)
#[test]
fn test_prediction() {
    ...
    let encounter_times = [
        1_452_880.599_685_907_4,
        1_453_237.873_270_511_6,
        1_756_031.469_329_595_6,
        1_759_789.876_391_887_7,
    ];
...
fn test_prediction_with_burn() {
    ...
    let burn = Burn::new(
        earth,
        earth_mass,
        vessel_start_velocity.normalize(),
        vec2(1.0e3, 0.0),
        0.0,
    ...
    println!(
        "At end of burn, moon position={:?} velocity={:?}",
        model.position(moon),
        model.velocity(moon)
    );
    println!(
        "At end of burn, earth position={:?} velocity={:?}",
        model.position(earth),
        model.velocity(earth)
    );
    ...
    let encounter_times = [
        1_451_640.009_287_595_7,
        1_453_650.030_605_793,
        1_756_813.440_374_136,
        1_760_025.688_626_766_2,
    ];
