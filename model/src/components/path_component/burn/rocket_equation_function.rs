...
impl RocketEquationFunction {
    pub fn new(
        ...
        Self {
            ...
            fuel_consumption_kg_per_second,
            specific_impulse,
            burn_time,
        }
    }
    ...
    pub fn start(&self) -> Self {
        Self::new(
            ...
            self.fuel_consumption_kg_per_second,
    ...
    pub fn step_by_dv(&self, dv: f64) -> Option<Self> {
        ...
        let extra_burn_time = (self.mass() / self.fuel_consumption_kg_per_second)
            * (1.0 - f64::exp(-dv / (self.specific_impulse * STANDARD_GRAVITY)));
...
mod test {
    ...
    fn test_step() {
        ...
        let step_end_time = rocket_equation_function
            .step_by_dv(rocket_equation_function.end().used_dv())
            .unwrap()
            .burn_time();
